...
export const isCursorOnLine = (e, lineData, state) => {
    ...
    switch (toolItemNo) {
        ...
        case 9: {
            const [lineStartCoords, lineEndCoords, channelEndCoords] = getCoordsArray(state, points);
            const slope = (lineEndCoords.y - lineStartCoords.y) / (lineEndCoords.x - lineStartCoords.x);
            ...
            const onDiagonal2 = isCursorOnTrendLine(e, { points: [newPoint1, newPoint2] }, state)
            if (onDiagonal1 !== -1) {
