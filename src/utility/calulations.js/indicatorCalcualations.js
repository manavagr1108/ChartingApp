...
export const calculateAlligator = (data, indicator) => {
...
export const calculateIchimokuCloud = (data, indicator) => {
  const { conversionPeriod, basePeriod, spanBPeriod, laggingSpanPeriod } =
    indicator;
