...
export const drawTrendLine = (state, i, lineSelected = false, fromDrawChart = false) => {
    ...
    switch (lineData.toolItemNo) {
        ...
        case 8:
            ...
            break;
        case 9:
            drawParallelChannelUsingPoints(state, canvas, points, lineSelected, fromDrawChart, ctx1);
            break;
    }
};
...
export const drawParallelChannel = (
    ...
    if (lineSelected) {
        ...
        drawTrendLineUsingPoints(
            state,
            canvas,
            [{ x: lineStartCoords.x, y: newY }, { x: lineEndCoords.x, y: channelEndCoords.y }],
            false,
            ctx1
        );
        const ctx = canvas.getContext("2d");
